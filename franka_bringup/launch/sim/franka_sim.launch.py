    ...
    launch_actions = [
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'physics_wall_pacing': LaunchConfiguration('physics_wall_pacing'),
                'physics_timing_path': LaunchConfiguration('physics_timing_path'),
                'physics_cpu_affinity': LaunchConfiguration('physics_cpu_affinity'),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('headless', default_value='false', description='Disable the MuJoCo window.'),
        DeclareLaunchArgument('render_offscreen', default_value='true', description='Enable camera rendering; busy frames are skipped.'),
        DeclareLaunchArgument('no_render', default_value='false', description='Disable both window and offscreen rendering.'),
        DeclareLaunchArgument('unpause', default_value='false', description='Start simulation immediately.'),
        DeclareLaunchArgument('realtime', default_value='1.0', description='Target simulation speed; -1 uses unlimited legacy stepping.'),
        DeclareLaunchArgument('physics_wall_pacing', default_value='true', description='Pace individual physics steps against wall time.'),
        DeclareLaunchArgument('physics_timing_path', default_value='', description='Optional outer-loop timing CSV; existing file is overwritten.'),
        DeclareLaunchArgument('physics_cpu_affinity', default_value='-1', description='Linux CPU index for physics; -1 keeps current affinity.'),
